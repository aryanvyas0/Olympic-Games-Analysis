...
-- MAGIC %md # Discover more about the Olympic Games.
-- MAGIC This notebook contains various charts based on a sample Olympic Games dataset.  
-- MAGIC * Note - this dataset joins the athlete_events_final table with the noc_regions country codes table.
-- MAGIC * Note - the country names do not match completely, since the noc_regions country codes are not compatiable with ISO 3166-1 alpha-3 standard.

-- COMMAND ----------

-- DBTITLE 1,Olympic events (athlete-events) Data frame Definition
-- MAGIC %scala 
-- MAGIC 
...
-- DBTITLE 1,Printing the Schema of the Data frame
-- MAGIC %scala
-- MAGIC 
...
-- DBTITLE 1,Modifying 'String' to 'Double' Datatype in the Data frame
-- MAGIC %scala 
...
-- DBTITLE 1,Creating a temporary View from the Data Frame
-- MAGIC %scala
-- MAGIC 
...
-- DBTITLE 1,Printing he Schema of the Data frame
-- MAGIC %scala
-- MAGIC 
...
-- MAGIC Datatype issue has been resolved.

-- COMMAND ----------

-- DBTITLE 1,Distribution of ages of all the gold medalists
-- MAGIC %sql
-- MAGIC 
...
-- DBTITLE 1,Gold Medals of all the Athletes, who are above 50 based on Sports
-- MAGIC %sql
-- MAGIC 
...
-- DBTITLE 1,Women medals per each edition of the Games. (summer season)
-- MAGIC %sql 
-- MAGIC 
...
-- DBTITLE 1,Which country has won most golds?
-- MAGIC %sql 
-- MAGIC 
...
-- DBTITLE 1,Distribution by sports for gold medals in USA
-- MAGIC %sql 
-- MAGIC 
...
-- DBTITLE 1,Height vs Weight of all Olympic Gold Medalists
-- MAGIC %sql
-- MAGIC 
...
-- MAGIC %md
-- MAGIC We can observe some outliers.

-- COMMAND ----------

-- DBTITLE 1,Variation of Male Athletes over time (participation)
-- MAGIC %sql
-- MAGIC 
...
-- DBTITLE 1,Variation of Female Athletes over time (participation)
-- MAGIC %sql 
-- MAGIC 
...
-- DBTITLE 1,Variation of Age of Male Athletes over time
-- MAGIC %sql
-- MAGIC 
...
-- DBTITLE 1,Weight over the years - Female Gymnasts
...
-- DBTITLE 1,Weight over the years - Male Lifters
...
-- DBTITLE 1,Weight over the years - Female Lifters
...
-- DBTITLE 1,Height over the years - Male Lifters
...
-- DBTITLE 1,Height over the years - Female Lifters
...
-- MAGIC %md
-- MAGIC # As we can see, some countries were not found. 
-- MAGIC * These create inconsistencies in our visualization.
-- MAGIC * So, we will map the missing countries with the correct code.
